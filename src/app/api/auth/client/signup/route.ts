...
export async function POST(req: NextRequest) {
  try {
    ...
    // 3. Créer le profil client dans client_profiles
    await adminDb.collection('client_profiles').doc(uid).set({
      id: uid,
      userId: uid,
      firstName: firstName || '',
      lastName: lastName || '',
    ...
    // 4. Définir le custom claim de rôle
