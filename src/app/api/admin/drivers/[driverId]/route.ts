...
export async function GET(_: NextRequest, { params }: { params: { driverId: string } }) {
  try {
    ...
    const driver = {
      ...
      license_doc_url: p.license_doc_url || "",
      ...
      registration_doc_url: p.registration_doc_url || "",
      // Statuts approbation individuels
      license_status: p.license_status || "pending",
      license_comment: p.license_comment || "",
      insurance_status: p.insurance_status || "pending",
      insurance_comment: p.insurance_comment || "",
      registration_status: p.registration_status || "pending",
      registration_comment: p.registration_comment || "",
