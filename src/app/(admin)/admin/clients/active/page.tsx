...
export default function ClientsActivePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Clients actifs</h1>
        <p className="text-muted-foreground mt-1">Liste des clients ayant passé au moins une commande</p>
      </div>
