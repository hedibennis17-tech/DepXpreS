...
export default function Page() {
  ...
  useEffect(() => {
    if (!clientId) return;
    fetch(`/api/admin/clients/${{clientId}}/promotions`)
      .then(r => r.json())
      .then(d => setData(d.promotions || d.client || d))
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Promotions du client</h1>
