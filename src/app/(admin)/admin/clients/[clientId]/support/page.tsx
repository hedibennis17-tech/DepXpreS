...
export default function Page() {
  ...
  useEffect(() => {
    if (!clientId) return;
    fetch(`/api/admin/clients/${{clientId}}/support`)
      .then(r => r.json())
      .then(d => setData(d.tickets || d.client || d))
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Tickets support du client</h1>
