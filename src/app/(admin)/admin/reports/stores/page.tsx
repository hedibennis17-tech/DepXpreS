...
export default function ReportStoresPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Rapport des dépanneurs</h1>
          <p className="text-muted-foreground mt-1">Performance des dépanneurs partenaires et revenus générés</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="rounded-xl border bg-card p-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">Dépanneurs actifs</p>
        </div>
        <div className="rounded-xl border bg-card p-4 text-center">
