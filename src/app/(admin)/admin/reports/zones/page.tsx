...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/admin/reports?type=zones').then(r => r.json()).then(d => setData(d)).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Rapport par zones</h1>
        <p className="text-muted-foreground mt-1">Données analytiques: Rapport par zones</p>
      </div>
