...
export default function ReportZonesPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Rapport des zones</h1>
          <p className="text-muted-foreground mt-1">Activité par zone géographique, couverture et performance</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="rounded-xl border bg-card p-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">Commandes/zone</p>
        </div>
        <div className="rounded-xl border bg-card p-4 text-center">
          <p className="text-2xl font-bold text-orange-600">—</p>
          <p className="text-xs text-muted-foreground mt-1">Zone top</p>
        </div>
        <div className="rounded-xl border bg-card p-4 text-center">
