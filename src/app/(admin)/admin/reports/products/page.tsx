  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Rapport des produits</h1>
          <p className="text-muted-foreground mt-1">Produits les plus vendus, ruptures de stock et tendances</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="rounded-xl border bg-card p-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">Plus vendus</p>
        </div>
        <div className="rounded-xl border bg-card p-4 text-center">
          <p className="text-2xl font-bold text-red-600">—</p>
          <p className="text-xs text-muted-foreground mt-1">Ruptures stock</p>
        </div>
        <div className="rounded-xl border bg-card p-4 text-center">
