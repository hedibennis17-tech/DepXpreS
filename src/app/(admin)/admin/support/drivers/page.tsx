...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/admin/support?userType=driver').then(r => r.json()).then(d => setData(d)).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Gestion des tickets: Tickets chauffeurs</p>
      </div>
