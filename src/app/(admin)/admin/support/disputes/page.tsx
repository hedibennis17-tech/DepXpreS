...
export default function SupportDisputesPage() {
  ...
  useEffect(() => {
    fetch("/api/admin/support/disputes")
      .then(r => r.json())
      .then(d => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Litiges</h1>
        <p className="text-muted-foreground mt-1">Litiges et réclamations en cours</p>
      </div>
