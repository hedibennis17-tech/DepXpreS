...
export default function SupportStoresPage() {
  ...
  useEffect(() => {
    fetch("/api/admin/support/tickets?type=store")
      .then(r => r.json())
      .then(d => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Tickets dépanneurs</h1>
        <p className="text-muted-foreground mt-1">Tickets de support ouverts par les dépanneurs</p>
      </div>
