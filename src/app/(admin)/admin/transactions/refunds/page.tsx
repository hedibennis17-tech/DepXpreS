...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/admin/transactions?type=payment&status=refunded').then(r => r.json()).then(d => setItems(d.transactions || d.payouts || d.wallets || d.tickets || [])).finally(() => setLoading(false));
  }, []);
