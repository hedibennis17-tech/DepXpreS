...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/admin/transactions?type=payment').then(r => r.json()).then(d => setItems(d.transactions || d.payouts || d.wallets || d.tickets || [])).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Paiements clients</h1>
