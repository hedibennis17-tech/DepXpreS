...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/admin/notifications').then(r => r.json()).then(d => setItems(d.notifications || [])).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Historique des notifications</h1>
