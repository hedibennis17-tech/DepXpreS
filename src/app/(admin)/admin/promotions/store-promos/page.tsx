...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/admin/promotions?type=store').then(r => r.json()).then(d => setItems(d.promotions || [])).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Promotions dépanneurs</h1>
