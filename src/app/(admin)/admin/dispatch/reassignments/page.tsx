...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/admin/dispatch?status=reassigned').then(r => r.json()).then(d => setData(d)).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Réassignations</h1>
