...
export default function DriverOrdersPage() {
  ...
  useEffect(() => {
    fetch("/api/admin/drivers/orders")
      .then(r => r.json())
      .then(d => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Livraisons du chauffeur</h1>
        <p className="text-muted-foreground mt-1">Historique des livraisons effectuées</p>
      </div>
        ...
        {filtered.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <th className="text-left px-4 py-3 text-xs font-semibold text-muted-foreground uppercase">Durée</th>
