...
export default function DriversVehiclesPage() {
  ...
  useEffect(() => {
    fetch("/api/admin/drivers/vehicles")
      .then(r => r.json())
      .then(d => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Véhicules enregistrés par les chauffeurs</p>
      </div>
        ...
        {filtered.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <th className="text-left px-4 py-3 text-xs font-semibold text-muted-foreground uppercase">Véhicule</th>
              <th className="text-left px-4 py-3 text-xs font-semibold text-muted-foreground uppercase">Plaque</th>
              <th className="text-left px-4 py-3 text-xs font-semibold text-muted-foreground uppercase">Année</th>
