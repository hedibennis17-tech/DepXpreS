...
export default function DriversActivePage() {
  ...
  useEffect(() => {
    fetch("/api/admin/drivers?status=active")
      .then(r => r.json())
      .then(d => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Chauffeurs actifs</h1>
        <p className="text-muted-foreground mt-1">Chauffeurs actuellement disponibles sur la plateforme</p>
      </div>
