...
import { Zap, Mail, Lock, Eye, EyeOff, ArrowLeft, Loader2, User } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1">Livraison gratuite sur votre 1ère commande</p>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 p-8">
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              Déjà un compte ?{' '}
              <Link href="/client/login" className="text-orange-600 font-semibold hover:underline">
                Se connecter
              </Link>
            </p>
          </div>
